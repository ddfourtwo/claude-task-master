...
5. Place your PRD document in the `scripts/` directory (e.g., `prd.md`)
...
3. Place your PRD document in the `scripts/` directory (e.g., `prd.md`)
...
```
Please use the task-master parse-prd command to generate tasks from my PRD. The PRD is located at prd.md.
```
...
```
I've just initialized a new project with Claude Task Master. I have a PRD at prd.md.
